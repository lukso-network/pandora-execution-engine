...
Smart contract execution engine, based on [go-ethereum](https://github.com/ethereum/go-ethereum), to work in concert with the [LUKSO orchestrator](https://github.com/lukso-network/lukso-orchestrator).
