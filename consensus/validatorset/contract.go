...
func (c *Contract) SignalToChange(first bool, receipts types.Receipts, header *types.Header, simulatedBackend bind.ContractBackend) ([]common.Address, bool, bool) {
	return c.validators.SignalToChange(first, receipts, header, simulatedBackend)
}
...
func (c *Contract) PrepareBackend(header *types.Header, simulatedBackend bind.ContractBackend) error {
	return c.validators.PrepareBackend(header, simulatedBackend)
}
